...
<template>
    <GuestLayout title="Department">
        <!-- Hero Section -->
        <section
            class="py-16 bg-gradient-to-br from-white via-gray-50" 
            :style="{ '--tw-gradient-to': 'var(--color-background)' }"
        >
            <div class="container-custom">
                <div class="text-center max-w-4xl mx-auto mb-20 space-y-6">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full" 
                        ...
                        <span class="font-semibold text-sm tracking-wide uppercase"
                    ...
                    <h1 class="text-5xl md:text-6xl font-bold leading-tight"
                        ...
                        <span class="block text-2xl md:text-3xl font-light mt-4"
                              :style="{ color: 'var(--light-text)' }">
                            HMJTK Polban
                        </span>
                    </h1>
                    <div class="flex items-center justify-center gap-2">
                        <div class="w-12 h-1 rounded-full" 
                             :style="{ backgroundColor: 'var(--color-primary)' }"></div>
                ...
                <div class="flex flex-wrap gap-3 justify-center max-w-4xl mx-auto">
                    <button
                        ...
                        :style="activeDepartment === department.id ? {
                    ...
                    >
                        <span class="relative z-10">{{ department.dept_name }}</span>
                        <div 
            ...
            <div class="container-custom">
                <div v-for="department in departments" :key="department.id">
                    ...
                    >
                        ...
                        <div v-if="department.board_members?.length" class="space-y-12">
                            <div class="text-center max-w-3xl mx-auto space-y-6">
                                <div class="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full">
                                    <div class="w-2 h-2 bg-blue-600 rounded-full"></div>
                                    <span class="text-blue-600 font-semibold text-sm tracking-wide uppercase">
                                        Board of Department
                                    </span>
                                </div>
                            ...
                            <div class="relative max-w-7xl mx-auto">
                                ...
                                <div v-if="getLayoutType(department.board_members) === 'carousel'">
                                    <Carousel
                                        :items-to-show="3"
                                        :wrap-around="true"
                                        :transition="500"
                                        ...
                                        >
                                            <div class="member-card">
                                                ...
                                                <div class="card-header">
                                                    ...
                                                    <p class="member-job-title">{{ member.job_titles }}</p>
                                                </div>
                                                <!-- Card Body -->
                                                <div class="card-body">
                                                    <div class="member-image-container">
                                                        ...
                                                        <div v-else class="member-placeholder">
                                                            <span class="placeholder-text">{{ member.name[0] }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div v-else-if="getLayoutType(department.board_members) === 'grid-2'" 
                                     class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                                    <div v-for="member in department.board_members" :key="member.id" class="member-card">
                                        <!-- Card Header -->
                                        <div class="card-header">
                                            <h3 class="member-name">{{ member.name }}</h3>
                                            <p class="member-position">{{ member.position }}</p>
                                ...
                                <div v-else-if="getLayoutType(department.board_members) === 'single'" 
                                     class="flex justify-center">
                                    <div v-for="member in department.board_members" :key="member.id" 
                        ...
                        <div v-if="department.section_heads?.length" class="space-y-12">
                            <div class="text-center max-w-3xl mx-auto space-y-6">
                                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full" 
                                     :style="{ backgroundColor: 'var(--color-secondary)', opacity: '0.2' }">
                            ...
                            <div class="relative max-w-7xl mx-auto">
                                <!-- Carousel Layout (>3 members) -->
                                <div v-if="getLayoutType(department.section_heads) === 'carousel'">
                                    <Carousel
                                        :items-to-show="3"
                                        :wrap-around="true"
                                        :transition="500"
                                ...
                                <!-- Grid Layout (2 members) -->
                                <div v-else-if="getLayoutType(department.section_heads) === 'grid-2'" 
                                     class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                                    <div v-for="member in department.section_heads" :key="member.id" class="member-card">
                                        <!-- Card Header -->
                                        <div class="card-header">
                                            <h3 class="member-name">{{ member.name }}</h3>
                                            <p class="member-position">{{ member.position }}</p>
                                ...
                                <!-- Single Layout (1 member) -->
                                <div v-else-if="getLayoutType(department.section_heads) === 'single'" 
                                     class="flex justify-center">
                                    <div v-for="member in department.section_heads" :key="member.id" 
                                         class="member-card max-w-sm">
                                        <!-- Card Header -->
                                        <div class="card-header">
                                            <h3 class="member-name">{{ member.name }}</h3>
                        ...
                        <!-- Staff Section -->
                        <div v-if="department.staff_members?.length" class="space-y-12">
                            <div class="text-center max-w-3xl mx-auto space-y-6">
                                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full" 
                                     :style="{ backgroundColor: 'var(--color-secondary)', opacity: '0.2' }">
                                    <div class="w-2 h-2 rounded-full" 
                            ...
                            <div class="relative max-w-7xl mx-auto">
                                <!-- Carousel Layout (>3 members) -->
                                <div v-if="getLayoutType(department.staff_members) === 'carousel'">
                                    <Carousel
                                        :items-to-show="3"
                                        :wrap-around="true"
                                        :transition="500"
                                ...
                                <!-- Grid Layout (2 members) -->
                                <div v-else-if="getLayoutType(department.staff_members) === 'grid-2'" 
                                     class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                                    <div v-for="member in department.staff_members" :key="member.id" class="member-card">
                                        <!-- Card Header -->
                                        <div class="card-header">
                                            <h3 class="member-name">{{ member.name }}</h3>
                                            <p class="member-position">{{ member.position }}</p>
                                ...
                                <!-- Single Layout (1 member) -->
                                <div v-else-if="getLayoutType(department.staff_members) === 'single'" 
                                     class="flex justify-center">
                                    <div v-for="member in department.staff_members" :key="member.id" 
                                         class="member-card max-w-sm">
                                        <!-- Card Header -->
                                        <div class="card-header">
                                            <h3 class="member-name">{{ member.name }}</h3>
