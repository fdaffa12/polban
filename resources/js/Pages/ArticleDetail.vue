<template>
    <GuestLayout title="Detail Artikel">
        ...
        <section class="relative py-20 overflow-hidden" :style="{ backgroundColor: 'white' }">
            <div class="container-custom relative z-10">
                <div class="max-w-4xl mx-auto">
                    <nav class="flex items-center space-x-2 text-sm mb-8" :style="{ color: 'var(--light-text)' }">
                        <a href="/" class="hover:text-[var(--color-primary)] transition-colors duration-300">Home</a>
                        <span>/</span>
                        <a href="/news" class="hover:text-[var(--color-primary)] transition-colors duration-300">News</a>
                        <span>/</span>
                    ...
                    <div class="flex items-center space-x-6 text-sm" :style="{ color: 'var(--light-text)' }">
            ...
            <div class="container-custom relative z-10">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div v-if="article.tags && article.tags.length > 0" class="mb-12">
                        <h3 class="text-lg font-semibold mb-4" :style="{ color: 'var(--text-color)' }">Tags:</h3>
                    ...
                    <!-- Share Buttons -->
                    <div class="border-t border-b py-8 mb-12" :style="{ borderColor: 'var(--color-secondary)' }">
                        <h3 class="text-lg font-semibold mb-4" :style="{ color: 'var(--text-color)' }">Bagikan Artikel:</h3>
        ...
        <!-- Related Articles -->
        <section v-if="relatedArticles.length > 0" class="py-16" :style="{ backgroundColor: 'var(--color-background)' }">
            <div class="container-custom">
                <div class="max-w-6xl mx-auto">
                    <h2 class="text-3xl font-bold text-center mb-12" :style="{ color: 'var(--text-color)' }">
                        Artikel Terkait
                    </h2>
