        ...
        <div class="p-6">
            ...
            <form @submit.prevent="submit" class="mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div>
                        ...
                        <input
                            type="file"
                            @input="
                                eventForm.event_flyer = $event.target.files[0]
                            "
                            class="mt-1 block w-full"
                    ...
                    <div>
                        <InputLabel for="event_gallery" value="Event Gallery" />
                        <input
                            type="file"
                            @input="
                    ...
                    <div>
                        <InputLabel for="event_doc" value="Event Document" />
                        <input
                            type="file"
                            @input="
                ...
                <div class="mb-6">
                    ...
                    >
                        <div class="flex-1">
                            <InputLabel :for="`date_${index}`" value="Date" />
                            <input
                                :id="`date_${index}`"
                        ...
                        <div class="flex-1">
                            <InputLabel :for="`time_${index}`" value="Time" />
                            <input
                                :id="`time_${index}`"
        ...
        <div class="p-4 sm:p-6" v-if="selectedEvent">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="space-y-4">
                    <!-- Event Flyer -->
                    <div>
                        <h3 class="text-sm font-medium mb-2">Event Flyer</h3>
                        <div
                        ...
                        >
                            <img
                                ...
                                @click="
                                    openImagePreview(selectedEvent.event_flyer)
                                "
                            />
                        </div>
                    </div>
                    ...
                    <!-- Event Gallery -->
                    <div>
                        <h3 class="text-sm font-medium mb-2">Event Gallery</h3>
                        <div
