...
@section('content')
    ...
    <div
        ...
        <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
            Halo <strong style="color: #2d3748;">{{ $spj->proposal->pic_name }}</strong>,
        </p>

        <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
            SPJ untuk kegiatan <strong style="color: #2d3748;">"{{ $spj->proposal->nama_kegiatan }}"</strong>
            memerlukan revisi.
        </p>
    </div>
    ...
    <div
        ...
        <div
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{ route('proposals.spj.show', ['proposal' => $spj->proposal_id, 'spj' => $spj->id]) }}"
